---
name: implement-plan
description: Implement an approved engineering plan in bounded, validated steps. Use when the user wants to carry out a plan from ./docs/plans/{planname}.md.
---
...
Use this skill to carry out an approved plan from `./docs/plans/{planname}.md`.

This is an engineer-led implementation stage.

Requirements:
- the user or upstream workflow must name the plan to implement
- read the plan file before making changes
- keep any execution summary in `./docs/executions/{planname}.md` if a run log is needed
